const profile = {
  ...
  identity:
    "我现在是对外经济贸易大学本科生，即将入读复旦大学管理学院 DDIM 项目。过去这段时间里，我分别在看 AI 的 VC、投后、战略团队和 AI 产品实践里工作过。也正因为这些经历交叉在一起，我越来越明确自己想去的方向，不是泛泛的战略或商业分析，而是更聚焦的 AI 投资、AI 产品和 AI 战略。",
  valuesIntro:
  ...
  results: [
    {
      ...
      text: "在看 AI 的 VC 团队里，我围绕短剧、电商、机器人等方向完成赛道拆解、访谈纪要、竞品测评和商业化分析，6 个月内累计完成 70+ 篇会议纪要、10 篇 IC Memo 和 3 篇深度研究。",
    },
    {
